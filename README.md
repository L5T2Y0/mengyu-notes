...
🌐 **在线访问**: [imengyu.space](https://imengyu.space/)
...
- [Hugo](https://gohugo.io/installation/) (_extended 版本，建议 v0.159+)
- Git
...
博客原创文章采用 [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/) 许可协议，转载请注明出处。

## 相关项目

- [online-student-exam-system](https://github.com/L5T2Y0/online-student-exam-system) — 在线考试系统（SpringBoot + Vue）
- [daily-hn-archives](https://github.com/L5T2Y0/daily-hn-archives) — Hacker News 每日热文自动归档

## 致谢

- [Hugo](https://gohugo.io/) — 闪电般的静态站点生成器
- [PaperMod](https://github.com/adityatelange/hugo-PaperMod) — 简洁优雅的 Hugo 主题
- [Cloudflare Pages](https://pages.cloudflare.com/) — 快速可靠的静态网站托管
